#!/bin/sh
export PACKAGEID="Carshowroom_1:7251c893e9b577c0e486a6e704df42ee0e87118ad104604c94194642abbddbcb"
echo $PACKAGEID
...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA -C samplechannel -n Carshowroom --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1 